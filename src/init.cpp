...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/irlecoin-project/irlecoin>";
    const std::string URL_WEBSITE = "<https://irlecoin.org>";
