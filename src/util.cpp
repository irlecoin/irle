...
const char * const BITCOIN_CONF_FILENAME = "irlecoin.conf";
const char * const BITCOIN_PID_FILENAME = "irlecoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "IrleCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/IrleCoin";
#else
    // Unix
    return pathRet / ".irlecoin";
#endif
#endif
}
