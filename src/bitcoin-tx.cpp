...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s irlecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  irlecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded irlecoin transaction") + "\n" +
              "  irlecoin-tx [options] -create [commands]   " + _("Create hex-encoded irlecoin transaction") + "\n" +
              "\n";
